...
UPDATE_FREQ = 100   #number of needles to toss before updating plot (natural numbers)
...
FLOORBOARD_WIDTH = 2 #spacing between floorbaord lines (twice needle length works out nicely for pi approximation)
